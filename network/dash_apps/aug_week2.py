...
node_df, edge_df, theme_index, nodes, edges = load_weekly_data('aug_week2')
...
# Dash app
app = DjangoDash('dash_app_aug_week2', add_bootstrap_links=True, external_stylesheets=["/static/css/font.css"])
...
def display_cluster_network(main_node_data, cluster_node_data, search_n_clicks, search_n_submit, search_value, week = 'aug_week2'):
